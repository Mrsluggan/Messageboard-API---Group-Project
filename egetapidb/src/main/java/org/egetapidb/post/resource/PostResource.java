...
public class PostResource {
    ...
    @APIResponse(responseCode = "200", description = "Alla inlägg")
    @APIResponse(responseCode = "204", description = "Fanns inga inlägg")
    ...
    @Path("/user/{userId}")
    @APIResponse(responseCode = "200", description = "Inläggen hämtades framgångsrikt")
    ...
    @Path("/{userId}")
    @APIResponse(responseCode = "201", description = "Inlägget skapades framgångsrikt")
    @APIResponse(responseCode = "400", description = "Ogiltig begäran")
    @APIResponse(responseCode = "500", description = "Internt serverfel")
    public Response createPost(@Valid Post post, @PathParam("userId") @Min(1) Long userId,
    ...
    @APIResponse(responseCode = "204", description = "Inlägget togs bort framgångsrikt")
    ...
    @Path("/{userId}/post/{postId}")
    @APIResponse(responseCode = "200", description = "Inlägget ändrades framgångsrikt")
    @APIResponse(responseCode = "404", description = "Inlägget hittades inte")
    @APIResponse(responseCode = "500", description = "Internt serverfel")
    ...
    @Path("/count")
    @APIResponse(responseCode = "200", description = "Antalet inlägg returnerades framgångsrikt")
    @APIResponse(responseCode = "500", description = "Internt serverfel")
